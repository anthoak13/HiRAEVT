...
void HTFilter::CreateUnpackers(json stackList)
{
...
void HTFilter::UnpackStack(UShort_t *pEvent, UInt_t eventSize)
{
...
ULong_t HTFilter::getLong(std::vector<UShort_t> &event, ULong_t offset)
{
