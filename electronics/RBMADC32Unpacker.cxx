...
RBMADC32Unpacker::RBMADC32Unpacker(const char *chName)
...
//______________________________________________________________________________
RBMADC32Unpacker::~RBMADC32Unpacker() {}


//______________________________________________________________________________
void RBMADC32Unpacker::Clear(Option_t *option)
{
...
//______________________________________________________________________________
void RBMADC32Unpacker::InitClass()
{}

//______________________________________________________________________________
void RBMADC32Unpacker::InitBranch(TTree *tree)
{
  if(GetFillData()){
    tree->Branch(fChName, fData, Form("%s[%i]/S",fChName.Data(),fnCh));
  }else{
    cout << "-->RBMADC32Unpacker::InitBranch  Branches will not be created or filled." << endl;
  }
}


//______________________________________________________________________________
void RBMADC32Unpacker::InitTree(TTree *tree)
{
  fChain = tree;
}
 ...
 */
//______________________________________________________________________________
Int_t RBMADC32Unpacker::Unpack(vector<UShort_t>& event, UInt_t offset)
{
  Clear();
...
//______________________________________________________________________________
Int_t RBMADC32Unpacker::DecodeVSN(Int_t header)
{
  // --
  //
...
//______________________________________________________________________________
void RBMADC32Unpacker::PrintSummary()
{
  printf("-- module %s --\n", fChName.Data());
...
//______________________________________________________________________________
void RBMADC32Unpacker::AddTTreeUserInfo(TTree *tree)
{
