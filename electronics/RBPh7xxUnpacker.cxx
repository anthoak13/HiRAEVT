...
ClassImp(RBPh7xxUnpacker)

void RBPh7xxUnpacker::Clear(Option_t *option)
{
  memset(fData,'\0',fnCh);
}

void RBPh7xxUnpacker::InitClass()
{
}

void RBPh7xxUnpacker::InitBranch(TTree *tree)
{
  Char_t tmp[500];
...
void RBPh7xxUnpacker::InitTree(TTree *tree)
{
  fChain = tree;
}
 ...
 */
Int_t RBPh7xxUnpacker::Unpack(UShort_t *p)
{
  Clear();
  
  ++p;                            // Skip over the id.
  UShort_t hitPattern = *p; ++p;  // Use the hit pattern to get the data count:
