...
HTNeutronWallData::HTNeutronWallData(int num_bars) : fmulti(0)
{
...
//________________________________________________
HTNeutronWallRootEvent::HTNeutronWallRootEvent(int num_bars) : fNumBars(num_bars), fNeutronWall(fNumBars) {}
