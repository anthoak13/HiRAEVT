...
HTMicroballData::HTMicroballData(int num_detectors) : fmulti(0)
{
...
//________________________________________________
HTMicroballRootEvent::HTMicroballRootEvent(int num_detectors) : fNumDetectors(num_detectors), fMicroball(fNumDetectors)
{
}
