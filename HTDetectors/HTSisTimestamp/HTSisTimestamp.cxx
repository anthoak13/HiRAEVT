...
HTSisTimestamp::HTSisTimestamp(const char *name, int num_detectors) : HTDetector(name, num_detectors), fevt(0)
{
   fevt = new HTSisTimestampRootEvent(num_detectors);
...
{
   theTree->Branch(Form("%s.", fName.c_str()), "HTSisTimestampData", &(fevt->fSisTimestamp), 32768, 1);
}
