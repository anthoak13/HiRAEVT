//
// File generated by rootcint at Wed Apr 18 12:48:54 2018
...
namespace ROOTDict {
   ...
   static ROOT::TGenericClassInfo *GenerateInitInstanceLocal(const ::RBSetup*)
   {
      ...
      static ::ROOT::TGenericClassInfo 
         instance("RBSetup", ::RBSetup::Class_Version(), "./RBSetup.h", 12,
...
/* RBSetup */
static int G__RBSetupDict_578_0_1(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
   RBSetup* p = NULL;
...
static int G__RBSetupDict_578_0_2(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
static int G__RBSetupDict_578_0_3(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letint(result7, 85, (long) RBSetup::Class());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__RBSetupDict_578_0_4(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letint(result7, 67, (long) RBSetup::Class_Name());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__RBSetupDict_578_0_5(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letint(result7, 115, (long) RBSetup::Class_Version());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__RBSetupDict_578_0_6(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      RBSetup::Dictionary();
      G__setnull(result7);
   return(1 || funcname || hash || result7 || libp) ;
...
static int G__RBSetupDict_578_0_10(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
static int G__RBSetupDict_578_0_11(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letint(result7, 67, (long) RBSetup::DeclFileName());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__RBSetupDict_578_0_12(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letint(result7, 105, (long) RBSetup::ImplFileLine());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__RBSetupDict_578_0_13(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letint(result7, 67, (long) RBSetup::ImplFileName());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__RBSetupDict_578_0_14(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
static int G__RBSetupDict_578_0_15(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
...
static int G__RBSetupDict_578_0_16(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
   char* gvp = (char*) G__getgvp();
...
static int G__RBSetupDict_578_0_17(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
extern "C" void G__cpp_setup_typetableRBSetupDict() {
   ...
   G__setnewtype(-1,NULL,0);
   G__search_typename2("vector<RBModuleInfo*>",117,G__get_linked_tagnum(&G__RBSetupDictLN_vectorlERBModuleInfomUcOallocatorlERBModuleInfomUgRsPgR),0,-1);
   G__setnewtype(-1,NULL,0);
   G__search_typename2("reverse_iterator<const_iterator>",117,G__get_linked_tagnum(&G__RBSetupDictLN_reverse_iteratorlEvectorlERBModuleInfomUcOallocatorlERBModuleInfomUgRsPgRcLcLiteratorgR),0,G__get_linked_tagnum(&G__RBSetupDictLN_vectorlERBModuleInfomUcOallocatorlERBModuleInfomUgRsPgR));
   G__setnewtype(-1,NULL,0);
   G__search_typename2("reverse_iterator<iterator>",117,G__get_linked_tagnum(&G__RBSetupDictLN_reverse_iteratorlEvectorlERBModuleInfomUcOallocatorlERBModuleInfomUgRsPgRcLcLiteratorgR),0,G__get_linked_tagnum(&G__RBSetupDictLN_vectorlERBModuleInfomUcOallocatorlERBModuleInfomUgRsPgR));
   G__setnewtype(-1,NULL,0);
   G__search_typename2("vector<RBDAQStackInfo*>",117,G__get_linked_tagnum(&G__RBSetupDictLN_vectorlERBDAQStackInfomUcOallocatorlERBDAQStackInfomUgRsPgR),0,-1);
   G__setnewtype(-1,NULL,0);
   G__search_typename2("reverse_iterator<const_iterator>",117,G__get_linked_tagnum(&G__RBSetupDictLN_reverse_iteratorlEvectorlERBDAQStackInfomUcOallocatorlERBDAQStackInfomUgRsPgRcLcLiteratorgR),0,G__get_linked_tagnum(&G__RBSetupDictLN_vectorlERBDAQStackInfomUcOallocatorlERBDAQStackInfomUgRsPgR));
   G__setnewtype(-1,NULL,0);
   G__search_typename2("reverse_iterator<iterator>",117,G__get_linked_tagnum(&G__RBSetupDictLN_reverse_iteratorlEvectorlERBDAQStackInfomUcOallocatorlERBDAQStackInfomUgRsPgRcLcLiteratorgR),0,G__get_linked_tagnum(&G__RBSetupDictLN_vectorlERBDAQStackInfomUcOallocatorlERBDAQStackInfomUgRsPgR));
   G__setnewtype(-1,NULL,0);
...
static void G__setup_memfuncRBSetup(void) {
   ...
   G__memfunc_setup("RBSetup",677,G__RBSetupDict_578_0_1, 105, G__get_linked_tagnum(&G__RBSetupDictLN_RBSetup), -1, 0, 0, 1, 1, 0, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("Print",525,G__RBSetupDict_578_0_2, 121, -1, -1, 0, 0, 1, 1, 0, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("Class",502,G__RBSetupDict_578_0_3, 85, G__get_linked_tagnum(&G__RBSetupDictLN_TClass), -1, 0, 0, 3, 1, 0, "", (char*)NULL, (void*) G__func2void( (TClass* (*)())(&RBSetup::Class) ), 0);
   G__memfunc_setup("Class_Name",982,G__RBSetupDict_578_0_4, 67, -1, -1, 0, 0, 3, 1, 1, "", (char*)NULL, (void*) G__func2void( (const char* (*)())(&RBSetup::Class_Name) ), 0);
   G__memfunc_setup("Class_Version",1339,G__RBSetupDict_578_0_5, 115, -1, G__defined_typename("Version_t"), 0, 0, 3, 1, 0, "", (char*)NULL, (void*) G__func2void( (Version_t (*)())(&RBSetup::Class_Version) ), 0);
   G__memfunc_setup("Dictionary",1046,G__RBSetupDict_578_0_6, 121, -1, -1, 0, 0, 3, 1, 0, "", (char*)NULL, (void*) G__func2void( (void (*)())(&RBSetup::Dictionary) ), 0);
   ...
   G__memfunc_setup("StreamerNVirtual",1656,G__RBSetupDict_578_0_10, 121, -1, -1, 0, 1, 1, 1, 0, "u 'TBuffer' - 1 - ClassDef_StreamerNVirtual_b", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("DeclFileName",1145,G__RBSetupDict_578_0_11, 67, -1, -1, 0, 0, 3, 1, 1, "", (char*)NULL, (void*) G__func2void( (const char* (*)())(&RBSetup::DeclFileName) ), 0);
   G__memfunc_setup("ImplFileLine",1178,G__RBSetupDict_578_0_12, 105, -1, -1, 0, 0, 3, 1, 0, "", (char*)NULL, (void*) G__func2void( (int (*)())(&RBSetup::ImplFileLine) ), 0);
   G__memfunc_setup("ImplFileName",1171,G__RBSetupDict_578_0_13, 67, -1, -1, 0, 0, 3, 1, 1, "", (char*)NULL, (void*) G__func2void( (const char* (*)())(&RBSetup::ImplFileName) ), 0);
   G__memfunc_setup("DeclFileLine",1152,G__RBSetupDict_578_0_14, 105, -1, -1, 0, 0, 3, 1, 0, "", (char*)NULL, (void*) G__func2void( (int (*)())(&RBSetup::DeclFileLine) ), 0);
   // automatic copy constructor
   G__memfunc_setup("RBSetup", 677, G__RBSetupDict_578_0_15, (int) ('i'), G__get_linked_tagnum(&G__RBSetupDictLN_RBSetup), -1, 0, 1, 1, 1, 0, "u 'RBSetup' - 11 - -", (char*) NULL, (void*) NULL, 0);
   // automatic destructor
   G__memfunc_setup("~RBSetup", 803, G__RBSetupDict_578_0_16, (int) ('y'), -1, -1, 0, 0, 1, 1, 0, "", (char*) NULL, (void*) NULL, 1);
   // automatic assignment operator
   G__memfunc_setup("operator=", 937, G__RBSetupDict_578_0_17, (int) ('u'), G__get_linked_tagnum(&G__RBSetupDictLN_RBSetup), -1, 1, 1, 1, 1, 0, "u 'RBSetup' - 11 - -", (char*) NULL, (void*) NULL, 0);
...
G__linked_taginfo G__RBSetupDictLN_vectorlERBModuleInfomUcOallocatorlERBModuleInfomUgRsPgR = { "vector<RBModuleInfo*,allocator<RBModuleInfo*> >" , 99 , -1 };
G__linked_taginfo G__RBSetupDictLN_reverse_iteratorlEvectorlERBModuleInfomUcOallocatorlERBModuleInfomUgRsPgRcLcLiteratorgR = { "reverse_iterator<vector<RBModuleInfo*,allocator<RBModuleInfo*> >::iterator>" , 99 , -1 };
G__linked_taginfo G__RBSetupDictLN_vectorlERBDAQStackInfomUcOallocatorlERBDAQStackInfomUgRsPgR = { "vector<RBDAQStackInfo*,allocator<RBDAQStackInfo*> >" , 99 , -1 };
G__linked_taginfo G__RBSetupDictLN_reverse_iteratorlEvectorlERBDAQStackInfomUcOallocatorlERBDAQStackInfomUgRsPgRcLcLiteratorgR = { "reverse_iterator<vector<RBDAQStackInfo*,allocator<RBDAQStackInfo*> >::iterator>" , 99 , -1 };
...
extern "C" void G__cpp_reset_tagtableRBSetupDict() {
  ...
  G__RBSetupDictLN_vectorlERBModuleInfomUcOallocatorlERBModuleInfomUgRsPgR.tagnum = -1 ;
  G__RBSetupDictLN_reverse_iteratorlEvectorlERBModuleInfomUcOallocatorlERBModuleInfomUgRsPgRcLcLiteratorgR.tagnum = -1 ;
  G__RBSetupDictLN_vectorlERBDAQStackInfomUcOallocatorlERBDAQStackInfomUgRsPgR.tagnum = -1 ;
  G__RBSetupDictLN_reverse_iteratorlEvectorlERBDAQStackInfomUcOallocatorlERBDAQStackInfomUgRsPgRcLcLiteratorgR.tagnum = -1 ;
...
extern "C" void G__cpp_setup_tagtableRBSetupDict() {
   ...
   G__get_linked_tagnum_fwd(&G__RBSetupDictLN_vectorlERBModuleInfomUcOallocatorlERBModuleInfomUgRsPgR);
   G__get_linked_tagnum_fwd(&G__RBSetupDictLN_reverse_iteratorlEvectorlERBModuleInfomUcOallocatorlERBModuleInfomUgRsPgRcLcLiteratorgR);
   G__get_linked_tagnum_fwd(&G__RBSetupDictLN_vectorlERBDAQStackInfomUcOallocatorlERBDAQStackInfomUgRsPgR);
   G__get_linked_tagnum_fwd(&G__RBSetupDictLN_reverse_iteratorlEvectorlERBDAQStackInfomUcOallocatorlERBDAQStackInfomUgRsPgRcLcLiteratorgR);
