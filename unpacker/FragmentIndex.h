...
struct FragmentInfo {
   ...
   FragmentInfo() : s_timestamp(0), s_sourceId(0), s_size(0), s_barrier(0), s_itemhdr(0), s_itembody(0) {}
};
...
public:
    ...
    */
   void indexFragments(uint16_t *data, size_t max_bytes) { indexFragments(data, data + max_bytes / sizeof(uint16_t)); }
