...
void RBExperiment::Setup()
{
  ...
  for(int NumStack=0; NumStack<gRun->GetNStacks(); NumStack++)
  {
    ...
    for(int NumModule = 0; NumModule < newStackInfo->GetNModules(); NumModule++)
    {
      ...
      // WARNING: RBHINPUnpacker, RBSisTimestampUnpacker and RBTimestamp have negative VSN.
      // In such a case we give to RBUSBStack::AddToStack() vsn=-1
