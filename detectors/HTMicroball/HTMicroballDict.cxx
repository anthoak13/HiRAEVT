...
namespace ROOT {
   static void *new_HTMicroballRootEvent(void *p = 0);
   static void *newArray_HTMicroballRootEvent(Long_t size, void *p);
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const ::HTMicroballRootEvent*)
   {
      ...
      static ::ROOT::TGenericClassInfo 
         instance("HTMicroballRootEvent", ::HTMicroballRootEvent::Class_Version(), "HTMicroballRootEvent.h", 16,
                  typeid(::HTMicroballRootEvent), DefineBehavior(ptr, ptr),
                  &::HTMicroballRootEvent::Dictionary, isa_proxy, 4,
                  sizeof(::HTMicroballRootEvent) );
      instance.SetNew(&new_HTMicroballRootEvent);
      instance.SetNewArray(&newArray_HTMicroballRootEvent);
...
namespace ROOT {
   // Wrappers around operator new
   static void *new_HTMicroballRootEvent(void *p) {
      return  p ? new(p) ::HTMicroballRootEvent : new ::HTMicroballRootEvent;
   }
   static void *newArray_HTMicroballRootEvent(Long_t nElements, void *p) {
      return p ? new(p) ::HTMicroballRootEvent[nElements] : new ::HTMicroballRootEvent[nElements];
   }
   // Wrapper around operator delete
   static void delete_HTMicroballRootEvent(void *p) {
