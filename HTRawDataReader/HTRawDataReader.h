...
public:
   ...
   int InitReader();    //! Called after mapper and input tree are set to initialize input tree branches. Returns -1 if
                        //! failed to create TTreeReader. -2 failed to retrieve Root input file(s)
